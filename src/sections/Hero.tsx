...
export const Hero = () => {
  ...
  return (
    <section
      ref={heroRef}
      className="overflow-x-clip bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,#183EC2,#EAEEFE)] pb-20 pt-8 md:pb-10 md:pt-5"
    >
      <div className="container items-center md:flex">
        ...
        <div className="relative mt-20 md:mt-0 md:h-[648px] md:flex-1">
          ...
          <motion.img
            ...
            width={220}
            alt=""
            className="absolute left-[448px] top-[524px] hidden md:block"
            style={{
              rotate: 30,
              translateY,
            }}
